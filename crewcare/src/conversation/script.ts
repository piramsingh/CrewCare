...
/**
 * The simulated push notification shown once a worker opts into alerts.
 *
 * Deliberately the same shape as the in-thread sample: what is happening, and
 * what to do about it. No ratio, no median.
 */
export const PUSH_PREVIEW =
  '👋 Good Morning, the 42nd street has some dust build-up and pretty hot, make sure to grab a N95 mask before you go to work today.'
