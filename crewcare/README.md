...
| Message thread | Simulated. No message is sent; iMessage and WhatsApp are skins. |
...
- **Health-app connection needs a native app.** Apple Health is reachable only
...
- **The mark is deliberately generic.** The agency's roundel is its trademark,
  and pairing it with an employee-credential field reads as a phishing page
  even in a prototype.
